...
ON PRIMARY
(NAME =  EduTec_Dat, FILENAME='E:\ISIL DESARROLLO DE SOTFWARE\DESARROLLO DE APLICACIONES\DESARROLLO DE APLICACIONES 1\Proyecto InstutuTec\Base de datos\InstituTec.mdf', 
 SIZE = 5MB, MAXSIZE = 200, FILEGROWTH = 1 )
LOG ON
(NAME = EduTec_Log, FILENAME ='E:\ISIL DESARROLLO DE SOTFWARE\DESARROLLO DE APLICACIONES\DESARROLLO DE APLICACIONES 1\Proyecto InstutuTec\Base de datos\InstituTec.ldf',
...
CREATE TABLE TB_Alumno (
       IdAlumno             char(5) NOT NULL,  --Recomendacion: Volverlo AUTO_INCREMENT
...
CREATE TABLE TB_Local (
       IdLocal             char(1) NOT NULL,  -- Recomendacion: VOLVERLO AUTO_INCREMENT
